...
//  MovieApp
//
//  Created by Hung Nguyen on 11/15/15.
...
class DvdMovieViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    func getData(){
        let connection = connectedToNetwork()
